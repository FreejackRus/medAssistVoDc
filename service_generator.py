...
class ServiceGenerator:
    ...
    def _get_top_services(self, step_text: str, top_k: int = 1500) -> pd.DataFrame:
    ...
    def _create_ai_prompt(self, services_text: str, step_title: str, step_text: str) -> str:
        ...
        return (
            ...
            "Не добавляй пояснений, описаний или markdown, а также вводны слов. В твоём ответе только json.\n\n"
