...
## Corpus Check
- 151 files · ~66,857 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1298 nodes · 2857 edges · 62 communities (59 shown, 3 thin omitted)
...
### Community 2 - "api.ts"
Cohesion: 0.08
Nodes (31): accountEventReconnectDelay(), isTerminalAccountEventError(), useAccountEvents(), Algorithm, AlgorithmGenerationMode, algorithmPdfFilename(), exportPdf(), useAlgorithm() (+23 more)
...
Cohesion: 0.13
Nodes (25): ChatWindow(), Props, AttachmentList(), formatFileSize(), MessageBubble(), Props, relativeTime(), Props (+17 more)
...
### Community 12 - "cn"
Cohesion: 0.13
Nodes (23): baseNavItems, Button(), buttonVariants, ConfirmDialog(), ConfirmDialogProps, Dialog(), DialogContent(), DialogDescription() (+15 more)
...
Cohesion: 0.11
Nodes (25): ChatInput(), formatFileSize(), Props, SidebarContent(), fields, ProfileForm(), ProfileFormProps, AdminRoute() (+17 more)
...
Cohesion: 0.13
Nodes (21): CalculatorCard(), getDefaultValues(), parseValues(), Props, validateFields(), Checkbox(), Select(), SelectOption (+13 more)

### Community 20 - "RecommendationCard.tsx"
Cohesion: 0.10
Nodes (32): ALGORITHM_MODES, AlgorithmView(), Props, Props, RecommendationCard(), DocumentCard(), Props, statusConfig (+24 more)
...
### Community 28 - "stream"
Cohesion: 0.17
Nodes (17): AccountEventRow, emit_account_event(), emit_admin_users_changed(), EventsQuery, format_event(), AuthUser, Bytes, Error (+9 more)

### Community 29 - "toast.tsx"
Cohesion: 0.12
Nodes (13): config, Toast, ToastAction, ToastContext, ToastContextValue, ToastProvider(), ToastType, AuthProvider() (+5 more)
...
Cohesion: 0.12
Nodes (14): AdminUsersPage, App(), CalculatorGroupPage, CalculatorsPage, ChangePasswordPage, ChatPage, ClinicalRecsPage, HomePage (+6 more)
...
Cohesion: 0.38
Nodes (4): ThemeToggle(), Theme, ThemeState, useThemeStore
