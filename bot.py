...
class MedicalAssistant:
    ...
    def _generate_streaming(self, sections: Dict[str, str], file: TextIO) -> None:
        ...
        system_prompt = (
            ...
            " Если в рекомендациях одно исследование исключает другое - включи это и распиши."
            "Используй маркированные списки и подразделы. "
            "Все ответы формируются исключительно на основе текста клиических рекомендаций "
