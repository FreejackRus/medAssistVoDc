...
class MedicalAssistant:
    ...
    def generate_services_for_step(self, step_text: str, step_title: str = "") -> List[Dict[str, str]]:
        ...
        system_prompt = (
            ...
            "**ИНСТРУКЦИИ:**\n"
            "- Ищи услуги, которые соответствуют описанным процедурам, исследованиям или методам\n"
            "- Обращай внимание на ключевые слова: УЗИ, анализы, исследования, диагностика, лечение\n"
            "- Если в тексте упоминается конкретная процедура (например, УЗИ органов брюшной полости), найди соответствующую услугу\n"
            "- Отвечай **только** валидным JSON-массивом\n"
            "- Максимум 5 наиболее релевантных услуг\n"
            "- Формат: [{\"id\": \"123\", \"name\": \"Название услуги\"}]\n"
            "- Если подходящих услуг нет — верни: []\n\n"
            f"Доступные услуги:\n{services_text}\n\n"
