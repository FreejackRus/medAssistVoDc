...
class MedicalAssistant:
    ...
    def _generate_streaming(self, sections: Dict[str, str], file: TextIO) -> None:
        ...
        system_prompt = (
            ...
            "Включи все данные: числа, единицы измерения, названия препаратов, дозы, критерии, сроки. "
        ...
        На их основе напиши максимально подробный со всеми описаниями и ньюансами, структурированный алгоритм диагностики и лечения, ориентированный на Клинические рекомендации, представленные далее.
        Учти все ньюансы, исключения и важные уточнения, относительно диагностики и лечения. Например, при сахарном диабете в некоторых случаях не делается тест толерантности к глюкозе.
        ...
        1. Первичное обследование (все возможное) 
        2. Дополнительные методы  (все возможное)
        3. Дифференциальная диагностика (все возможное)
